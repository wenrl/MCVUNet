...
# segmentation_mask_overlay.overlay_masks()
...
def test_single_volume_ori(image, label, net, classes, patch_size=[256, 256], test_save_path=None, case=None, z_spacing=1, class_names=None):
